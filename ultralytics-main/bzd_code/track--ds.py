...
# 初始化模型
default_path = 'yolo11n.pt'
model = YOLO(input(f"请输入模型路径 (默认: {default_path}): ").strip() or default_path)

# 视频路径
default_pathA = 'baoan_video/前进路文汇中学对面2_2025-06-16_10-16-23_60s.mp4'
...
while cap.isOpened() and running:
    ...
    # YOLO推理
    results = model.track(frame,imgsz=1280,conf=0.1,iou=0.2,show_conf=False,classes=[1,3])
